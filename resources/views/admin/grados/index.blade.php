                                ...
                                <div class="modal-dialog">
                                    ...
                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                            <label for="for">Nivel</label>
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <select class="form-control" id="nivel_create" name="nivel_id_create" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                            <label for="for">Nombrte del Grado</label>
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                            ...
                            @foreach($niveles as $nivel)
                                <tr>
                                    ...
                                    <td>                                    
                                        ...
                                        <span class="badge badge-info btn-block">{{ $grado->nombre }}</span><br>
                                        @endforeach
                                    </td>
                                    <td>
                                             @foreach($nivel->grados as $grado)
                                            <div class="row d-flex justify-content-center">
                                                <button type="button " class="btn btn-success btn-sm py-0 px-2" data-toggle="modal" data-target="#updateModal{{ $grado->id }}">
                                                    <i class="fa fa-pencil-alt">Editar</i>
                                                </button>
                                     <form action="{{ route('admin.grados.destroy',$grado->id) }}" method="POST" id="miFormulario{{ $grado->id }}">
                                                @csrf
                                                    @method('DELETE')
                                                        <button type="submit" class="btn btn-danger btn-sm py-0 px-2" onclick="preguntar({{ $grado->id}},event)">
                                             ...
                                             <!-- Modal editar-->
                                                                    <div class="modal fade" id="updateModal{{$grado->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                    ...
                                                    <div class="form-group">
                                                            <label for="for">Gestiones</label>
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <select class="form-control" id="nivel_create" name="nivel_id" required>
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                                <label for="for">nombre</label>
                                                                                                    ...
                                                                                                    <input type="text" class="form-control" value="{{ old('nombre', $grado->nombre) }} " name="nombre" placeholder="resgistra nuevo periodo" required>
                                                                                                    </div>
